...
public class TextToSpeechAPI implements IBotCommand {

	public static final String API_KEY = System.getenv("TEXT_TO_SPEECH_KEY");
	...
	public String translateTextToSpeech(String textToSpeech) throws IOException {
	...
	public static String translateTextToSpeech2(String textToSpeech) throws IOException {
		String encodedText = URLEncoder.encode(textToSpeech, StandardCharsets.UTF_8.toString());
		String cachedFilePath = cache.get(encodedText);
		if (cachedFilePath != null) {
			return cachedFilePath; // Return cached file path if available
	...
	public static void main(String[] args) throws IOException {
		translateTextToSpeech2("Weather: Weather for the City of Bremen");
	}

	@Override
	public void execute(long chatId, String input, Bot2 bot) throws IOException {
		bot.activateFunctionality("useTTS");
	}
}
